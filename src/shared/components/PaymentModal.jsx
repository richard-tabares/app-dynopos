...
export const PaymentModal = ({ isOpen, status, message, onClose }) => {
    ...
    return (
        <section className={`fixed inset-0 bg-overlay w-full h-full flex flex-col items-center justify-center z-50 transition-opacity duration-300 ${closing ? 'opacity-0' : 'opacity-100'}`}
