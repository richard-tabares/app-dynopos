...
export const SideBar = () => {
    ...
    return (
        // aside bar
        <aside className='fixed flex flex-col left-0 top-0 border-r justify-between border-gray-300 w-64 h-screen bg-white'>
            {/* Logo */}
            <section className='h-16 border-b border-gray-300 flex items-center place-content-center gap-2 px-6'>
                <ShoppingCart className='w-8 h-8' />
                <span className='text-2xl font-semibold'>Dyno POS</span>
            </section>
            {/* Nav */}
