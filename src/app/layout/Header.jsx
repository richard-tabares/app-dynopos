...
export const Header = () => {
    ...
    return (
        <header className='fixed bg-white left-64 h-16 border-b border-gray-300 right-0 z-50 transition-transform duration-300 max-lg:-translate-x-64 max-lg:w-full'>
