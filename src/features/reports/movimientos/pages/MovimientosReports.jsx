...
import { History, Search, ArrowDownCircle, ArrowUpCircle, ShoppingCart, Undo2, Filter } from 'lucide-react'
...
export const MovimientosReports = () => {
    ...
    return (
        <section className='space-y-6'>
            ...
            <section className='bg-surface border border-outline rounded-lg shadow-xs overflow-hidden'>
                {loading ? (
                                ...
                                {filtered.map((m) => {
                                    ...
                                    return (
                                        <tr key={m.id} className='border-b border-divider-light hover:bg-hover'>
                                            ...
                                            <td className='py-3 px-4 text-right text-on-body'>
