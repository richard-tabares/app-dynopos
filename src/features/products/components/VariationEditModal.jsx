...
import { Loader, Save, Layers } from 'lucide-react'
import { Modal } from '../../../shared/components/Modal'
import { updateVariation as updateVariationApi } from '../helpers/updateVariation'

export const VariationEditModal = ({ variation, onClose, onSaved }) => {
    ...
    return (
        <Modal onClose={onClose} title='Editar Variación' icon={Layers}>
            <div className='p-6'>
                <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                    ...
                    <section className='flex items-center justify-between'>
                        <span className='text-sm font-medium text-on-body'>Activo</span>
